              ...
              <div class="alert alert-danger" style="border-radius:0;" v-if="isError">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="public_key" class="control-label">Public Address</label>
                        <input type="text" v-model="public_key" class="form-control" placeholder="Public Key" >
                        </div>
                    <div class="form-group">
                        <label for="private_key" class="control-label">Private Address</label>
                        <input type="text" v-model="private_key" class="form-control" placeholder="Private Key" >
                        </div>
                    </div>
    ...
    methods:{
      ...
      makeTransaction(){
        ...
        if(!this.private_key || !this.public_key) {
            swal('Error!', 'Please enter your public and private keys!');
            return;
        }
        ...
        axios.post(`{{ route('coinpayment.ajax.create.transfer') }}`, params)
          .then(function(json){
